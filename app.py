...
.case-card {
    ...
    box-shadow: 0px 4px 12px rgba(0,0,0,0.1); border-left: 6px solid;
    background-color: #ffffff; transition: transform 0.2s, box-shadow 0.2s;
}
.case-card:hover { transform: translateY(-3px); box-shadow: 0px 8px 18px rgba(0,0,0,0.15); }
...
.day-card {
    border-radius: 15px; padding: 10px; margin-bottom: 12px; background-color: #f5f5f5;
